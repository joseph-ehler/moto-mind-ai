...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // For development, create a mock URL since we don't have real Supabase
    const publicUrl = `https://ucbbzzoimghnaoihyqbd.supabase.co/storage/v1/object/public/vehicle-images/${filePath}`
