 ...
 * 
 * Core vehicle business logic types and utilities
 */
...
/**
 * Validate VIN format
 * VINs are 17 characters and cannot contain I, O, or Q
 */
 ...
 * In production, use a VIN decoder service like NHTSA
 */
export function parseVINInfo(vin: string): Partial<Vehicle> {
  ...
  // Basic implementation - returns VIN and placeholder display name
  return {
    vin: vin.toUpperCase(),
...
/**
 * Service record for vehicle maintenance
 */
...
/**
 * Fuel record for vehicle refueling
 */
...
/**
 * Odometer reading from various sources
 */
