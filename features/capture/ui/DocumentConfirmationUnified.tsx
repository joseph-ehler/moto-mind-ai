...
export function DocumentConfirmationUnified({ 
  isOpen, 
  onClose, 
  onConfirm, 
  onRetry, 
  ...
  // Modal states for the original modal-over-modal pattern
  const [showVehicleSelector, setShowVehicleSelector] = React.useState(false)
  const [showAssociationConfirm, setShowAssociationConfirm] = React.useState(false)
  const [showAssociationNotification, setShowAssociationNotification] = React.useState(false)
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      ...
      <AssociationConfirmation
        isOpen={showAssociationConfirm}
        onClose={() => setShowAssociationConfirm(false)}
      ...
      <AssociationNotification
        isOpen={showAssociationNotification}
        onClose={() => setShowAssociationNotification(false)}
        onUndo={() => {
