...
// Enhanced FileUpload (MotoMind patterns) - REFACTORED
...
export type { 
  ...
  ImageQuality,
  DetectionResult
} from './utilities/file-upload/types'

// Utilities & Helpers
export { FilePreview, type PreviewFile } from './utilities/FilePreview'
export { AIBadge, AIDisclaimer } from './utilities/AIBadge'
...
export {
  ...
  useReadingMode
} from './primitives/AdvancedTypography'

// Elite Typography Tokens & Utils
export { eliteTypography } from '@/lib/design-system/elite-typography'

// Surfaces
export { Surface } from './primitives/Surfaces'

// Card System (Enhanced from patterns + shadcn primitives)
// Architecture: shadcn (base) → patterns/Card (design system features)
export { Card } from './patterns/Card'
export { MomentumStack } from './MomentumStack'
export { AnimatedCard, AnimatedSection } from './AnimatedCard'
export { 
  CardHeader, 
  CardContent, 
  CardFooter,
...
} from './primitives/AdvancedSurfaces'
